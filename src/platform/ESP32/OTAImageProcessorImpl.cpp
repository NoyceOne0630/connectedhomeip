...
void OTAImageProcessorImpl::HandleFinalize(intptr_t context)
{
    ...
    ChipLogProgress(SoftwareUpdate, "OTA image downloaded to offset 0x%" PRIu32, imageProcessor->mOTAUpdatePartition->address);
...
void OTAImageProcessorImpl::HandleApply(intptr_t context)
{
    ...
    ESP_LOGI(TAG, "Applying, Boot partition set offset:0x%" PRIu32, imageProcessor->mOTAUpdatePartition->address);
