...
void CheckResendApplicationMessage(nlTestSuite * inSuite, void * inContext)
{
    ...
    ChipLogProgress(Test, "Attempt #1  Timeout : %" PRId32 " ms", timeoutTime.count());
    ...
    now         = System::SystemClock().GetMonotonicTimestamp();
    timeoutTime = now - startTime;
    ChipLogProgress(Test, "Attempt #2  Timeout : %" PRId32 " ms", timeoutTime.count());
    ...
    now         = System::SystemClock().GetMonotonicTimestamp();
    timeoutTime = now - startTime;
    ChipLogProgress(Test, "Attempt #3  Timeout : %" PRId32 " ms", timeoutTime.count());
    ...
    now         = System::SystemClock().GetMonotonicTimestamp();
    timeoutTime = now - startTime;
    ChipLogProgress(Test, "Attempt #4  Timeout : %" PRId32 " ms", timeoutTime.count());
