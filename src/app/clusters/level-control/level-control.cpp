...
#define STATETABLE_SIZE (EMBER_AF_LEVEL_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT + CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT)
#else
#define STATETABLE_SIZE EMBER_AF_LEVEL_CONTROL_CLUSTER_SERVER_ENDPOINT_COUNT
#endif
typedef struct
{
    CommandId commandId;
...
static EmberAfLevelControlState stateTable[STATETABLE_SIZE];
