...
class SampleEspCluster(private val controller: MatterController, private val endpointId: UShort) {
  ...
  suspend fun readMessageDownstreamAttribute(): ByteArray {
    ...
    requireNotNull(attributeData) { "Messagedownstream attribute not found in response" }
  ...
  suspend fun writeMessageDownstreamAttribute(
    value: ByteArray,
  ...
  suspend fun subscribeMessageDownstreamAttribute(
    minInterval: Int,
    maxInterval: Int
      ...
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Messagedownstream attribute not found in Node State update"
          }
  ...
  suspend fun readMessageUpstreamAttribute(): ByteArray {
    ...
    requireNotNull(attributeData) { "Messageupstream attribute not found in response" }
  ...
  suspend fun subscribeMessageUpstreamAttribute(
    minInterval: Int,
    maxInterval: Int
  ): Flow<ByteArraySubscriptionState> {
    val ATTRIBUTE_ID: UInt = 1u
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) {
            "Messageupstream attribute not found in Node State update"
          }
  ...
  companion object {
    private val logger = Logger.getLogger(SampleEspCluster::class.java.name)
    const val CLUSTER_ID: UInt = 320601120u
  }
}
