...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == SampleEsp.ID) {
            return new SampleEsp();
        }
    ...
    public static class SampleEsp implements BaseCluster {
        public static final long ID = 320601120L;
        public long getID() {
            return ID;
        }

        public enum Attribute {
            MessageDownstream(0L),
            MessageUpstream(1L),
            GeneratedCommandList(65528L),
            AcceptedCommandList(65529L),
            EventList(65530L),
