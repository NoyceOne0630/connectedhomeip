...
class ChipClusters:
    ...
    _SAMPLE_ESP_CLUSTER_INFO = {
        "clusterName": "SampleEsp",
        "clusterId": 0x131BFC20,
        "commands": {
        },
        "attributes": {
            0x00000000: {
                "attributeName": "MessageDownstream",
                "attributeId": 0x00000000,
                "type": "bytes",
                "reportable": True,
                "writable": True,
    ...
    _CLUSTER_ID_DICT = {
        ...
        0x131BFC20: _SAMPLE_ESP_CLUSTER_INFO,
    ...
    _CLUSTER_NAME_DICT = {
        ...
        "SampleEsp": _SAMPLE_ESP_CLUSTER_INFO,
