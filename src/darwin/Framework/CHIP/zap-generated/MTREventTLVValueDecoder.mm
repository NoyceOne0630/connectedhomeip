...
static id _Nullable DecodeEventPayloadForSampleESPCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
id _Nullable MTRDecodeEventPayload(const ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Clusters::SampleEsp::Id: {
        return DecodeEventPayloadForSampleESPCluster(aPath.mEventId, aReader, aError);
    }
