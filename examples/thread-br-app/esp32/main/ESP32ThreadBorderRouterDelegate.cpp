                                                             ...
                                                             ActivateDatasetCallback * callback)
{
    ...
    if (threadIsEnabled)
    {
        ...
        {
            callback->OnActivateDatasetComplete(Protocols::InteractionModel::Status::Success);
            return CHIP_NO_ERROR;
        }
...
void ESP32ThreadBorderRouterDelegate::OnPlatformEventHandler(const DeviceLayer::ChipDeviceEvent * event, intptr_t arg)
{
    ...
    if (delegate && delegate->mCallback)
    {
        ...
        {
            delegate->mCallback->OnActivateDatasetComplete(Protocols::InteractionModel::Status::Success);
