 ...
 * @param endpoint    Endpoint that is being initialized
 */
void emberAfSampleEspClusterInitCallback(chip::EndpointId endpoint);
 ...
 * @param endpoint    Endpoint that is being initialized
 */
void emberAfSampleEspClusterServerInitCallback(chip::EndpointId endpoint);

/**
 * @param endpoint    Endpoint that is being shutdown
 */
void MatterSampleEspClusterServerShutdownCallback(chip::EndpointId endpoint);

/**
 * @param endpoint    Endpoint that is being initialized
 */
void emberAfSampleEspClusterClientInitCallback(chip::EndpointId endpoint);

/**
 * @param attributePath Concrete attribute path that changed
 */
void MatterSampleEspClusterServerAttributeChangedCallback(const chip::app::ConcreteAttributePath & attributePath);
 ...
 */
chip::Protocols::InteractionModel::Status
MatterSampleEspClusterServerPreAttributeChangedCallback(const chip::app::ConcreteAttributePath & attributePath,
                                                        EmberAfAttributeType attributeType, uint16_t size, uint8_t * value);

/**
 * @param endpoint  Endpoint that is being served
 */
void emberAfSampleEspClusterServerTickCallback(chip::EndpointId endpoint);
